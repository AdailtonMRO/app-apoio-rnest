...
*   **Motivo da Solicitação / Causa Raiz**: Campo obrigatório na criação/edição de escalas contendo menu suspenso com as Causas Raiz padronizadas (Composição de Turno, Licença Médica, Férias, etc.). Garante a padronização e o rastreamento da causa raiz desde a abertura da vaga até a integração automática no histórico. O motivo é exibido nos cards de apoio e omitido do template de WhatsApp para evitar ruídos de comunicação.
